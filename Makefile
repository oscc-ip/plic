...
SRC_FILE ?=
SRC_FILE += ../rtl/prio_tree.sv
SRC_FILE += ../rtl/plic_gateway.sv
SRC_FILE += ../rtl/plic_core.sv
SRC_FILE += ../rtl/apb4_plic.sv
SRC_FILE += ../tb/plic_test.sv
SRC_FILE += ../tb/test_top.sv
SRC_FILE += ../tb/apb4_plic_tb.sv
